...
from uppf_processor import process_files
...
THEME_STYLESHEET = """
    ...
    QLabel#header_label {
        font-size: 18px;
        color: #9b59b6; /* Purple tint for UPPF */
        font-weight: bold;
    }
...
class App(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("UPPF: Обработка данных температур")
        self.resize(900, 750)
    ...
    def init_inner_ui(self, parent_widget):
        ...
        input_layout.addWidget(QLabel("📂 Папка с данными"))
    ...
    def select_input_folder(self):
        ...
        folder_path = QFileDialog.getExistingDirectory(self, "Выберите папку с данными", start_dir)
        if folder_path:
    ...
    def select_output_file(self):
        ...
        # Используем DontConfirmOverwrite согласно пожеланию пользователя (Вариант 1)
    ...
    def clear_cache(self):
        ...
        if CacheManager:
            cache = CacheManager("UPPF", output_file)
